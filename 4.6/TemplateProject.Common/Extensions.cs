...
namespace TemplateProject.Common
{
    public static class Extensions
    {
        ...
        public static object CreateResourceUri<T>(this PagedList<T> pagedList, SearchParameters searchParameters, HttpRequestMessage requestMessage, string getName)
        {
